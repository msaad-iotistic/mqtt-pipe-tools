...
do_install() {
    ...
    echo -e "  ${BOLD}mqtt-forward --connect host:22${NC}         # Forward TCP over MQTT (server, generates code)"
    echo -e "  ${BOLD}mqtt-forward --listen :8080 --code 42-cosmic-dolphin${NC}  # (client)"
    echo ""
